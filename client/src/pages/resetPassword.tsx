...
import { ResetPasswordMutation } from "../lib/mutations/ResetPasswordMutation";
...
const ResetTeacherPasswordPage: React.FC = () => {
  ...
  const { mutate } = useMutation(ResetPasswordMutation, {
    onSuccess: () => {
    ...
    <>
      <Box>
        <Box sx={{ width: "400px", marginX: "auto", marginTop: "40px" }}>
          <Box>
            <H4>
              Hey {data?.name}, Please re-set up your password , so that you can
